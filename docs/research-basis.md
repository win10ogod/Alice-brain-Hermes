...
及心理學研究方法資料，並稽核了 `心理學框架/參考/laap-AGI` 的實際工作區
快照。該 checkout 的 `HEAD` 為 `b055ac0161f7d001a59f8e03965f8c1403a3d890`，但稽核時
工作樹含未提交修改；因此下文的程式事實屬於該實際快照，不被歸因為純淨
commit 內容。這些資料是設計來源，不是安裝或執行時依賴；本儲存庫擁有自己的
package namespace、daemon、SQLite schema、協議與測試。
